...
export function HeaderHero({
  ...
  return (
    <header className="pt-10 pb-8">
      <div className="rounded-3xl border hairline bg-ink-900/60 shadow-soft overflow-hidden">
        <div className="p-8 md:p-10 bg-grid">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
            <div className="min-w-0">
              ...
              {tagline ? <p className="mt-2 text-sm muted">{tagline}</p> : null}
            ...
            <div className="relative h-28 w-28 md:h-32 md:w-32 shrink-0 rounded-2xl overflow-hidden border hairline bg-ink-850">
              {/* Put your avatar at: public/avatar.jpg (or .png/.webp) */}
              <Image
                src="/avatar.jpg"
                alt="Avatar"
                fill
